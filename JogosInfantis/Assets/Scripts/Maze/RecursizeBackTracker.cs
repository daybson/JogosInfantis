...
public class RecursizeBackTracker
{
    public const int _rowDimension = 0;
    public const int _columnDimension = 1;

    public int MinSize { get; private set; }
    public int MaxSize { get; private set; }
    public int[,] Cells { get; private set; }

    public RecursizeBackTracker() : this(3, 3) { }

    public RecursizeBackTracker(int rows, int columns)
    {
        MinSize = 3;
        MaxSize = 10;
